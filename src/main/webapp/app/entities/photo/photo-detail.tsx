      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>
              <TextFormat value={photoEntity.createdAt} type="date" format={APP_DATE_FORMAT} />
            </dd>
            <dt>
              <span id="updatedAt">Updated At</span>
            </dt>
            <dd>
              <TextFormat value={photoEntity.updatedAt} type="date" format={APP_DATE_FORMAT} />
            </dd>
            <dt>Steps</dt>
            <dd>
              {photoEntity.steps
                ? photoEntity.steps.map((val, i) => (
                    <span key={val.id}>
                      <a>{val.id}</a>
                      {i === photoEntity.steps.length - 1 ? '' : ', '}
                    </span>
                  ))
                : null}
            </dd>
