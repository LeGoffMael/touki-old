      ...
      <Row>
        <Col md="8">
          ...
          <dl className="jh-entity-details">
            ...
            <dd>
              <TextFormat value={commentEntity.updatedAt} type="date" format={APP_DATE_FORMAT} />
            </dd>
            <dt>Travel</dt>
            <dd>{commentEntity.travel ? commentEntity.travel.id : ''}</dd>
            <dt>Owner</dt>
            <dd>{commentEntity.owner ? commentEntity.owner.id : ''}</dd>
          </dl>
